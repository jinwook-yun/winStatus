...
{
    public partial class FrmOutDetail : UserControl
    {
        ...
        public void FrmOutDetail_Load(object sender, EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        private void gridView_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                pageEvent.PushPage("FrmOutDetail");
                pageEvent.MovePage("FrmOutCustomDetail", Query.QueryParam);
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.MonthDetail();
        }
