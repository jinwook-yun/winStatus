    ...
    public partial class FrmPopUp : Form
    {
        ...
        private void SetData()
        {
            ...
            { 
                ...
                DataTable DT = Query.MchInfoProdGDate();
                ...
                lblProdData3.Text = dr["stop_nm"].ToString();
        ...
        public void MatchData(string MachineCode)
        {
            try
            {
                ...
                sql = string.Format("EXEC SNSMESINC_MachineMonitoring_Detail '01', '{0}', ''", MachineCode);
                ...
                lblProdData2.Text = dr["itm_nm"].ToString();
                lblProdData3.Text = dr["stop_nm"].ToString();
                lblProdData4.Text = dr["nextitm"].ToString();
