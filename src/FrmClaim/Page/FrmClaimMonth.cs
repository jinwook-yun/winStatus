...
{
    public partial class FrmClaimMonth : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        System.Timers.Timer timer = null;
        public FrmClaimMonth()
        {
            InitializeComponent();
            InitializeTimer();
        ...
        public void FrmMonthClaim_Load(object sender, EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.ClaimMonth();
        }
