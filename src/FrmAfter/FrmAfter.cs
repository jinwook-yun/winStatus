...
{
    public partial class FrmAfter : Form
    {
        public PageEvent pageEvent = new PageEvent();
        FrmAfterList frmAfterList = new FrmAfterList();
        ...
        public FrmAfter()
        {
            ...
            frmAfterList.pageEvent.PageMove += PageMoveEvent;
        }
        ...
        {
            pageEvent.MovePage("FrmAfter", null);
        }
        ...
        private void PageMoveEvent(object sender, PageEventArgs e)
        {
            ...
            {
                case "FrmAfter":
                    panelMain.Controls.Add(frmAfterList);
                    break;              
            }
        }
