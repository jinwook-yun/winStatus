...
{
    public partial class FrmProdBadChart : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        //System.Timers.Timer timer = null; //타이머미사용
        public FrmProdBadChart()
        {
            InitializeComponent();
        ...
        {            
            ...
            // Certain Columns Find.
            int toDayval = int.Parse(DateTime.Now.ToString("dd"));
            if (toDayval - Interval.GridPosigion > 0 )
            {
                toDayval = toDayval - Interval.GridPosigion;
                pivotGridControl1.LeftTopCoord = new Point(toDayval, 1);
            }
