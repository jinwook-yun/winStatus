...
namespace WinStatusBoard
{
    public partial class FrmSetInterval : Form
    {
        public FrmSetInterval()
        {
            ...
            txtGridposition.Text = Interval.GridPosigion.ToString();
        }

        private void btnOK_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(txtInterval.Text) || string.IsNullOrEmpty(txtGridposition.Text))
            {
            ...
            Interval.GridPosigion = Convert.ToInt32(txtGridposition.Text);
            Close();
        }
