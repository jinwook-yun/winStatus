...
{
    public partial class FrmMatCustomDetail : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        System.Timers.Timer timer = null;
        public FrmMatCustomDetail()
        {
            InitializeComponent();
            InitializeTimer();
        ...
        public void FrmMatCustomDetail_Load(object sender, EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        private void gridView_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                ...
                pageEvent.PushPage("FrmMatCustomDetail");
                pageEvent.MovePage("FrmMatStockDetail", Query.QueryParam);
            }
        }
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.MaterialCustomStock();
        }
