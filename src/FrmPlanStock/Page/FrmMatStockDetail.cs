...
{
    public partial class FrmMatStockDetail : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        System.Timers.Timer timer = null;
        public FrmMatStockDetail()
        {
            InitializeComponent();
            InitializeTimer();
        ...
        public void FrmMatStockDetail_Load(object sender, EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.MaterialStockDetail();
        }
