...
{
    public partial class FrmMatCustomList : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        System.Timers.Timer timer = null;
        public FrmMatCustomList()
        {
            InitializeComponent();
            InitializeTimer();
        ...
        public void FrmMatCustomList_Load(object sender, System.EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.MaterialCustomList();
        }
        ...
        private void gridView_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            if (e.RowHandle >= 0)
            {
                ...
                pageEvent.PushPage("FrmMatCustomList");
                pageEvent.MovePage("FrmMatCustomDetail", Query.QueryParam);
            }
        }
