...
{
    public partial class FrmCustomDetail : UserControl
    {
        public PageEvent pageEvent = new PageEvent();
        System.Timers.Timer timer = null;
        public FrmCustomDetail()
        {
            InitializeComponent();
            InitializeTimer();
        ...
        public void FrmCustomDetail_Load(object sender, EventArgs e)
        {
            StartTimer();
            DataLoad();
        }
        ...
        private void gridView_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                string dicKey = "top_id";
                string category = gridView.GetRowCellDisplayText(e.RowHandle, gridView.Columns[dicKey]);
                Query.QueryParam = new Dictionary<string, string>() { { "itm_id", category } };

                pageEvent.PushPage("FrmCustomDetail");
                pageEvent.MovePage("FrmStockDetail", Query.QueryParam);
            }
        }
        ...
        public void DataLoad()
        {
            ...
            Grid.DataSource = Query.CustomStock();
        }
        ...
        private void gridView_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            //if (e.RowHandle >= 0)
            //{
            //    int fontSize = Convert.ToInt32(GetRowHeight() * 0.4);
            //    fontSize = (fontSize >= 40) ? 30 : fontSize;
            //    e.Appearance.Font = new System.Drawing.Font("맑은 고딕", fontSize, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
