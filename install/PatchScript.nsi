...
SetCompressor /FINAL /SOLID lzma        ;설치할 파일들을 압축할때 사용 설치파일의 용량 줄이는 옵션
...
OutFile               "${PRODUCT_SETUPFILE_FOLDER}\${PRODUCT_NAME}Patch_v${PRODUCT_VERSION}.exe"   ; 컴파일 후 생성될 설치 파일명
